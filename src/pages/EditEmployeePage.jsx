...
function EditEmployeePage({ employees, onEdit }) {
  ...
  // Adapter function: EmployeeForm calls onSubmit(data) but our top-level handler
  // needs onEdit(id, data). We wrap it here so EmployeeForm stays generic and reusable.
  const handleSubmit = (data) => {
    onEdit(employee.id, data);
  };
